...
export class VisitorWithoutMobile extends Component {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      await AsyncStorage.multiRemove(["visitorId","visitorMobile","visitorFirstName","visitorLastName","meetingName","purposeValue","visitTime","slipID",'visitorData'])
...
//   }
  ...
  async addVisitorData() {
    ...
    try {
      await AsyncStorage.setItem('visitorMobile',JSON.stringify(this.state.mobile));

      await AsyncStorage.setItem('visitorFirstName',JSON.stringify(this.state.fname));

      await AsyncStorage.setItem('visitorLastName',JSON.stringify(this.state.lname));
            ...
            <View style={styles.cardShadow}>
              <View style={styles.mgt}>
                <View style={styles.cdm}>
                  ...
                  <View style={[styles.action,{borderWidth:1,borderColor: '#f2f2f2',borderRadius:5}]}>
                    <Entypo name="mobile" color="#05375a" size={20} style={{paddingTop:10}}/>
                    ...
                    //   onPress={value => this.getVisitorData(value)}
                      style={{borderWidth: 1,padding:10,justifyContent:"center",alignItems:"center",borderTopRightRadius:5,borderBottomRightRadius:5}}>
                      <IconAntDesign
                        name="search"
                        size={25}
                        color="#696969"
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <View style={styles.wd}>
                      <LinearGradient
                        ...
                        <TouchableOpacity
                          onPress={() => this.props.navigation.goBack()}
                          style={[styles.touchBack, {justifyContent:"center",alignItems:"center"}]}>
                          <Text
                            style={{
                              padding: '5%',
                              marginTop: '2%',
